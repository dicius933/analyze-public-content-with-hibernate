...
/**
 * Created by yeshua on 1/28/2018.
 */
public class Prompter {
    ...
    // Hold a reusable reference ro a SessionFactory (Since we need only one)
    ...
    void run(){
        ...
        // Display meny and prompt for choice
        System.out.println("Welcome! Here are your meny options:");
        try{
            do{
    ...
    private void showStatistics() {
        ...
        Country lowestLiteracy = noNullLiteracy.stream()
                ...
                .get();
        System.out.printf("Country with the highest a" +
                "dult literacy rate: %s\t%.2f%n", highestLiteracy.getName(), highestLiteracy.getAdultLiteracyRate().doubleValue());
    ...
    private Country addCountry() throws IOException {
        ...
        Double adultLiteracy = setAdultLiteracyRate();
        ...
        do {
            ...
            switch (choice.toUpperCase()) {
                ...
                case "LITERACY":
                    ...
                    Double newRate = setAdultLiteracyRate();
    ...
    private Double setAdultLiteracyRate() throws IOException {
        boolean validEntry = true;
